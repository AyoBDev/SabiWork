...
export default function ScoreSection({ sabiScore }) {
  return (
    <div className="bg-white rounded-xl border border-warm-border p-4">
      <h3 className="text-sm font-semibold text-warm-text mb-3">Your Sabi Score</h3>
      <div className="flex items-center justify-around">
        <TrustRing score={sabiScore} />
        <div className="text-center">
          <p className="text-3xl font-bold text-warm-text">{sabiScore}</p>
          <p className="text-[10px] text-warm-muted">Sabi Score</p>
